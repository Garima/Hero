!function (a) {
  ...
  var b, c = "function" == typeof define && define.amd, d = function (b) {
    ...
    this.insertTab = function (a, b, c) {
      ...
      var c = j.ancestor(b.sc, j.isPara), d = j.splitTree(c, b.getStartPoint()), e = j.listDescendant(c, j.isEmptyAnchor);
      e = e.concat(j.listDescendant(d, j.isEmptyAnchor)), a.each(e, function (a, b) {
        j.remove(b)
    ...
    this.fontSize = function (a, b) {
      ...
      c.css({width: a.width() * b + "px", height: ""}), i(a)
    ...
    this.undo = function () {
      ...
      b.length > c && (b = b.slice(0, c)), b.push(e()), c++
    }, this.recordUndo()
  }, u = function () {
