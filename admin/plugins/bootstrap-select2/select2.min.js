  ...
  if (window.Select2 === t) {
    ...
    N = e(document), M = function () {
      ...
      bind: function (e) {
        ...
        } : e.is("optgroup") ? {text: e.attr("label"), children: [], element: e.get(), css: e.attr("class")} : void 0
      ...
      createContainer: function () {
        ...
        }), this.updateSelection(i), this.setPlaceholder(), s && this.triggerChange({added: i, removed: o}); else {
